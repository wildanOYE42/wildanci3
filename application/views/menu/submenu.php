                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button onclick="hapusSubMenu('<?= base_url('menu/hapussubmenu/') . $sm['id'] ?>')" class="badge badge-danger">Delete</button>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
...
<?php foreach ($subMenu as $sm) : ?>
    <div class="modal fade" id="newSubMenuModal<?= $sm['id']; ?>" tabindex="-1" aria-labelledby="newSubMenuModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="<?= base_url('menu/submenuedit/'); ?>" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="hidden" class="form-control" id="id" value="<?= $sm['id'] ?>" name="id" placeholder="Submenu Title">
                        </div>
                        <div class="form-group">
                            <select name="menu_id" id="menu_id" class="form-control">
